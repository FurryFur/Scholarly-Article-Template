...
\end{equation}
However, since we receive two outputs from our descriminator, the above equation needs to be modified as follows to incorporate the conditional and unconditional outputs.